...
\begin{ldesc}
	\li[entire tuple \C{s} and its values \C{a} and \C{b}]            s@(a,b)
	\li[entire list \C{a}, its head \C{x} and tail \C{xs}] a@(x:xs)
