...
\begin{ldesc}
	\fitem{local variable}    such \I{type} \I{name}=\I{value}
	\oitem{global variable}   much \I{type} \I{name}=\I{value}
	\oitem{volatile variable} so   \I{type} \I{name}=\I{value}
	\oitem{lists}             such \I{type} \I{name}[\I{size}]=\I{value}
\end{ldesc}
